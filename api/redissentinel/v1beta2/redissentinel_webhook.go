...
const (
	webhookPath = "/validate-redis-redis-k8s-vip-v1beta2-redissentinel"
)

// log is for logging in this package.
var redissentinellog = logf.Log.WithName("redissentinel-v1beta2-validation")

// +kubebuilder:webhook:path=/validate-redis-redis-k8s-vip-v1beta2-redissentinel,mutating=false,failurePolicy=fail,sideEffects=None,groups=redis.redis.opstreelabs.in,resources=redissentinels,verbs=create;update,versions=v1beta2,name=validate-redissentinel.redis.opstreelabs.in,admissionReviewVersions=v1
